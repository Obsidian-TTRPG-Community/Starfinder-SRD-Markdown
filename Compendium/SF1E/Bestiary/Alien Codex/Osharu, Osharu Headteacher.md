...
3rd (3/day)—_remove affliction_, _tongues_  
2nd (6/day)—_augury_, _force blast_ (DC 19), _hurl forcedisk_, _zone of truth_ (DC 19)  
1st (at will)—_identify_, _mystic cure_  
**Connection** Akashic

### STATISTICS

**STR** +1; **DEX** +2; **CON** +0; **INT** +4; **WIS** +6; **CHA** +2  
...
**Other Abilities** access Akashic record, Akashic knowledge, peer into the future (1/day), slime  
