...
**HP** 25  
**EAC** 13; **KAC** 15  
**Fort** +4; **Ref** +6; **Will** +1; –1 vs. mind-affecting effects  
...
**Ranged** diffraction perforator pistol +7 (1d4+2 So; critical bleed 1d4)

### Statistics

**STR** +1; **DEX** +4; **CON** +1; **INT** +0; **WIS** +1; **CHA** +2  
**Feats** Improved Feint  
**Skills** Acrobatics +7, Bluff +7, Sleight of Hand +12  
**Languages** Common, Worlanisi; limited telepathy 60 ft.  
**Other Abilities** distracting prattle, multiarmed (4) , worlanisi gamble , worlanisi luck  
**Gear** freebooter armor I, diffraction perforator pistol with 2 batteries (20 charges each), tactical switchblade
