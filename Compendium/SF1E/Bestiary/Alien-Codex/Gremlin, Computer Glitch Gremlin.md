...
**Source**:: _Alien Archive 2 pg. 68_
...
1/day—_erase_, _jolting surge_  
At will—_energy ray_ (electricity only), _ghost sound_ (DC 13), _transfer charge_  
Constant—_detect tech_ (computers only)
